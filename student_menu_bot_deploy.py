...
MENU = {
    ...
    "📄 ការសុំច្បាប់": (
        ...
        "📞 ទំនាក់ទំនងផ្នែកសេវានិស្សិត បើមានចម្ងល់បន្ថែម"
    ),
    ...
    "🎓 ការប្តូរជំនាញ": (
        "*ការប្តូរជំនាញសិក្សា*\n\n"
        "1. ពិគ្រោះជាមួយទីប្រឹក្សាការសិក្សាមុនសិន\n"
...
FALLBACK_MESSAGE = (
    "សូមអភ័យទោស ខ្ញុំមិនទាន់មានព័ត៌មានច្បាស់លាស់អំពីសំណួរនេះទេ។ "
    "សូមសាកល្បងសំណួររបស់អ្នកទៅកាន់បុគ្គលិក BBUSR ដើម្បីឱ្យគេជួយ។"
)
...
async def post_init(application):
    ...
    (ជិតអក្សរញញឹម) ឱ្យបង្ហាញអក្សរ 'ព័ត៌មានបន្ថែម' ហើយពេលចុច នឹងបើកគេហទំព័រ bbu.edu.kh"""
